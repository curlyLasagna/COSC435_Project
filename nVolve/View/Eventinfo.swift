...
struct EventInfo : View{
    ...
    @State private var favorited = false
     ...
     var perks: [String] //should hold and display all perks and event categories involved witht the evenet
    var body: some View{
        ZStack{
            ...
            VStack(alignment:.leading){
                ...
                image
                    .resizable()
                    .scaledToFit()
                // Ensures the image fills the available width
                Text("Time:\(time)")
                    .font(.largeTitle)
                Text("\(room)")
                    .font(.largeTitle)
...
#Preview {
    EventInfo(showEvent:.constant(true),
